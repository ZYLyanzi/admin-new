...
<template>
	<section>
		...
		<el-table :data="list" highlight-current-row  @selection-change="handleSelectionChange"  style="width: 100%;">
			...
			<el-table-column prop="name" label="被访人姓名" >
			</el-table-column>
			<el-table-column prop="name" label="联系人关系" >
			</el-table-column>
			<el-table-column prop="name" label="地址" >
			</el-table-column>
			<el-table-column prop="name" label="审批人" >
			</el-table-column>
			<el-table-column prop="name" label="审批日期" >
			</el-table-column>
			<el-table-column prop="name" label="审批说明" >
			</el-table-column>
			...
			<el-table-column label="操作" width="150">
				<template slot-scope="scope">
					<el-button size="small"  v-on:click="detail(scope.row.id)">详情</el-button>
					<el-button size="small"  v-on:click="detail(scope.row.id)">核准</el-button>
					<el-button size="small"  v-on:click="detail(scope.row.id)">拒绝</el-button>
				</template>
			</el-table-column>
		</el-table>
		<!--工具条-->
