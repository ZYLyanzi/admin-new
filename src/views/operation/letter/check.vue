...
<template>
	<section>
			...
			<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
				<el-form :inline="true" class="demo-form-inline">
					...
					<el-form-item  label="催收员">
						<el-input v-model="searchPra" placeholder="催收员"></el-input>
					</el-form-item>
					<el-form-item  label="案件编号">
						<el-input v-model="searchPra" placeholder="案件编号"></el-input>
					</el-form-item>
					...
					<el-form-item  label="地址">
						<el-input v-model="searchPra" placeholder="地址"></el-input>
					</el-form-item>
					<el-form-item  label="信函模板代码">
		...
		<el-table :data="list" highlight-current-row  @selection-change="handleSelectionChange"  style="width: 100%;">
			...
			<el-table-column prop="name" label="信函地址" >
			</el-table-column>
			<el-table-column prop="name" label="信函模板代码" width="150">
			</el-table-column>
			<el-table-column prop="name" label="打印时间" >
			</el-table-column>
			<el-table-column prop="name" label="打印状态" >
			</el-table-column>
			<el-table-column prop="name" label="信函打印人" >
			</el-table-column>
			<el-table-column prop="name" label="创建时间" >
			</el-table-column>
			<el-table-column label="操作" width="150">
				<template slot-scope="scope">
					<el-button size="small"  v-on:click="detail()">详情</el-button>
					<el-button size="small"  v-on:click="printing()">打印</el-button>
				</template>
			</el-table-column>
		</el-table>
		<!--工具条-->
