    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: editor.getOpt('uploadUrl'),
                formData: {
                    policy: '',
                    authorization: ''
                },
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                filename = filename.getTime() + parseInt(Math.random()*1000) + file.file.ext;
                let xmlhttp = new XMLHttpRequest();
                xmlhttp.onreadystatechange = function(xmlobj){};
                xmlhttp.open("GET",editor.getOpt('getUploadSignUrl')+'?path=1&save-key='+filename+'&pathIndex='+editor.getOpt('pathIndex'),false);
                xmlhttp.send(null);
                let _res = JSON.parse(xmlhttp.responseText);
                data.policy = _res.data.policy;
                data.authorization = _res.data.sign;
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    var responseText = (ret._raw || ret),
                        ...
                        json.state = json.code === 200 ?'SUCCESS':'ERROR';
